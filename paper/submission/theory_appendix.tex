% Derived from immutable paper/theory12.tex.
\subsection{Implemented recurrence and zero step}
...
\subsection{Skipping defects and state error}
...
\subsection{Cached readout and refresh}
...
\subsection{Fixed cost, refresh frequency and overhead}
