...
\caption{Frozen-model schematic. Binary inactive temporal steps copy hidden state;
readout reuse and spatial-context omission remain separate approximations.
The diagram distinguishes these claims from measured pipeline cost, and does not
specify kernel execution order.}\label{fig:architecture}
\end{adjustwidth}
\end{figure}
...
or scale/shape decomposition claims. Current-checkpoint qualitative sequences
and longer continuous evaluation remain useful extensions.
...
\input{reproducibility_details.tex}
